...
declare global {
  ...
  type SecondaryButtonRole = "settings" | "accept_necessary" | "accept_all";
  ...
  interface ConsentModalLanguageSetting {
    ...
    tertiary_btn?: ButtonSetting<SecondaryButtonRole>;
  ...
  interface CookieConsent {
    ...
    loadScript(
      src: string,
      callback: () => void | typeof onload,
      attrs?: ScriptAttribute[]
    ): void;
    updateScripts(): void;
